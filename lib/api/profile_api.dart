...
class ProfileApi {
  ...
  Future<Response> apiAccountMyProfileChangePasswordPostWithHttpInfo({ ChangePasswordInput? body, }) async {
  ...
  ///
  /// * [ChangePasswordInput] body:
  Future<void> apiAccountMyProfileChangePasswordPost({ ChangePasswordInput? body, }) async {
    final response = await apiAccountMyProfileChangePasswordPostWithHttpInfo( body: body, );
  ...
  Future<Response> apiAccountMyProfilePutWithHttpInfo({ UpdateProfileDto? body, }) async {
    // ignore: prefer_const_declarations
    final path = r'/api/account/my-profile';
  ...
  Future<ProfileDto?> apiAccountMyProfilePut({ UpdateProfileDto? body, }) async {
    final response = await apiAccountMyProfilePutWithHttpInfo( body: body, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
