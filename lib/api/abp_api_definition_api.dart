...
class AbpApiDefinitionApi {
  ...
  Future<Response> apiAbpApiDefinitionGetWithHttpInfo({ bool? includeTypes, }) async {
    ...
    if (includeTypes != null) {
      queryParams.addAll(_queryParams('', 'IncludeTypes', includeTypes));
    }
  ...
  Future<ApplicationApiDescriptionModel?> apiAbpApiDefinitionGet({ bool? includeTypes, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'ApplicationApiDescriptionModel',) as ApplicationApiDescriptionModel;
