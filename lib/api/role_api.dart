...
class RoleApi {
  ...
  Future<Response> apiIdentityRolesIdPutWithHttpInfo(String id, { IdentityRoleUpdateDto? body, }) async {
    // ignore: prefer_const_declarations
    final path = r'/api/identity/roles/{id}'
      .replaceAll('{id}', id);
  ...
  Future<IdentityRoleDto?> apiIdentityRolesIdPut(String id, { IdentityRoleUpdateDto? body, }) async {
    final response = await apiIdentityRolesIdPutWithHttpInfo(id,  body: body, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> apiIdentityRolesPostWithHttpInfo({ IdentityRoleCreateDto? body, }) async {
    // ignore: prefer_const_declarations
    final path = r'/api/identity/roles';
  ...
  Future<IdentityRoleDto?> apiIdentityRolesPost({ IdentityRoleCreateDto? body, }) async {
    final response = await apiIdentityRolesPostWithHttpInfo( body: body, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
