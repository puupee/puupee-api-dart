...
class AppSdkApi {
  AppSdkApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;

  final ApiClient apiClient;

  /// Performs an HTTP 'GET /api/app/app-sdk' operation and returns the [Response].
  Future<Response> apiAppAppSdkGetWithHttpInfo() async {
  ...
  Future<List<AppSdkDto>?> apiAppAppSdkGet() async {
    final response = await apiAppAppSdkGetWithHttpInfo();
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<AppSdkDto>') as List)
        .cast<AppSdkDto>()
        .toList();
  ...
  /// Performs an HTTP 'DELETE /api/app/app-sdk/{id}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [String] id (required):
  Future<Response> apiAppAppSdkIdDeleteWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [String] id (required):
  Future<void> apiAppAppSdkIdDelete(String id,) async {
    final response = await apiAppAppSdkIdDeleteWithHttpInfo(id,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> apiAppAppSdkPostWithHttpInfo({ CreateOrUpdateAppSdkDto? body, }) async {
    // ignore: prefer_const_declarations
    final path = r'/api/app/app-sdk';
