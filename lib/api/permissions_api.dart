...
class PermissionsApi {
  ...
  Future<Response> apiPermissionManagementPermissionsPutWithHttpInfo({ String? providerName, String? providerKey, UpdatePermissionsDto? body, }) async {
    // ignore: prefer_const_declarations
    final path = r'/api/permission-management/permissions';
  ...
  ///
  /// * [UpdatePermissionsDto] body:
  Future<void> apiPermissionManagementPermissionsPut({ String? providerName, String? providerKey, UpdatePermissionsDto? body, }) async {
    final response = await apiPermissionManagementPermissionsPutWithHttpInfo( providerName: providerName, providerKey: providerKey, body: body, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
