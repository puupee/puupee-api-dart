...
class EmailSettingsApi {
  ...
  Future<Response> apiSettingManagementEmailingPostWithHttpInfo({ UpdateEmailSettingsDto? body, }) async {
    // ignore: prefer_const_declarations
    final path = r'/api/setting-management/emailing';
  ...
  ///
  /// * [UpdateEmailSettingsDto] body:
  Future<void> apiSettingManagementEmailingPost({ UpdateEmailSettingsDto? body, }) async {
    final response = await apiSettingManagementEmailingPostWithHttpInfo( body: body, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> apiSettingManagementEmailingSendTestEmailPostWithHttpInfo({ SendTestEmailInput? body, }) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [SendTestEmailInput] body:
  Future<void> apiSettingManagementEmailingSendTestEmailPost({ SendTestEmailInput? body, }) async {
    final response = await apiSettingManagementEmailingSendTestEmailPostWithHttpInfo( body: body, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
