...
class SmsApi {
  ...
  ///
  /// * [SendSmsCodeDto] sendSmsCodeDto:
  Future<Map<String, dynamic>?> apiAppSmsSendChangePhoneCodePost({ SendSmsCodeDto? sendSmsCodeDto, }) async {
  ...
  ///
  /// * [SendSmsCodeDto] sendSmsCodeDto:
  Future<Map<String, dynamic>?> apiAppSmsSendLoginCodePost({ SendSmsCodeDto? sendSmsCodeDto, }) async {
