...
/// * [comment] 
@BuiltValue()
abstract class AppUserScoreDto implements Built<AppUserScoreDto, AppUserScoreDtoBuilder> {
  ...
  factory AppUserScoreDto([void updates(AppUserScoreDtoBuilder b)]) = _$AppUserScoreDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AppUserScoreDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AppUserScoreDto> get serializer => _$AppUserScoreDtoSerializer();
}

class _$AppUserScoreDtoSerializer implements PrimitiveSerializer<AppUserScoreDto> {
  @override
  final Iterable<Type> types = const [AppUserScoreDto, _$AppUserScoreDto];

  @override
  final String wireName = r'AppUserScoreDto';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AppUserScoreDto object, {
  ...
  void _deserializeProperties(
    ...
    required AppUserScoreDtoBuilder result,
  ...
  @override
  AppUserScoreDto deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AppUserScoreDtoBuilder();
