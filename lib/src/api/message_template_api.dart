...
class MessageTemplateApi {
  ...
  Future<Response<List<MessageTemplateDto>>> apiAppMessageTemplateGet({ 
    ...
    try {
_responseData = deserialize<List<MessageTemplateDto>, MessageTemplateDto>(_response.data!, 'List<MessageTemplateDto>', growable: true);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> apiAppMessageTemplateIdDelete({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<MessageTemplateDto>> apiAppMessageTemplateIdGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
