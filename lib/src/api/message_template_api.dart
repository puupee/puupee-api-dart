...
class MessageTemplateApi {
  ...
  const MessageTemplateApi(this._dio, this._serializers);
  ...
  Future<Response<MessageTemplateDto>> create({ 
    ...
    try {
      const _type = FullType(CreateOrUpdateMessageTemplateDto);
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(MessageTemplateDto),
  ...
  Future<Response<void>> delete({ 
    ...
    final _path = r'/api/app/message-template/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<MessageTemplateDto>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<MessageTemplateDto>>> getList({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<MessageTemplateDto>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(MessageTemplateDto)]),
      ) as BuiltList<MessageTemplateDto>;
    ...
    return Response<BuiltList<MessageTemplateDto>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
