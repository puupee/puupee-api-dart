...
class SyncStateApi {
  ...
  Future<Response<SyncStateDto>> callGet({ 
    ...
    final _path = r'/api/app/sync-state';
...
_responseData = deserialize<SyncStateDto, SyncStateDto>(_response.data!, 'SyncStateDto', growable: true);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PuupeeEto>> deviceConnectedEto({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/app/sync-state/device-connected-eto';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PuupeeEto _responseData;

    try {
_responseData = deserialize<PuupeeEto, PuupeeEto>(_response.data!, 'PuupeeEto', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Returns a [Future] containing a [Response] with a [PuupeeEto] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PuupeeEto>> puupeeChangedEto({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/app/sync-state/puupee-changed-eto';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
