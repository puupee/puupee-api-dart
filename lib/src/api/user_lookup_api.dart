...
class UserLookupApi {
  ...
  Future<Response<UserData>> apiIdentityUsersLookupByUsernameUserNameGet({ 
...
_responseData = deserialize<int, int>(_response.data!, 'int', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [UserData] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UserData>> apiIdentityUsersLookupIdGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = deserialize<UserData, UserData>(_response.data!, 'UserData', growable: true);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UserDataListResultDto>> apiIdentityUsersLookupSearchGet({ 
    String? filter,
    String? sorting,
    int? skipCount,
    int? maxResultCount,
