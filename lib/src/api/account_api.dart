...
class AccountApi {
  ...
  Future<Response<UserProfileDto>> callGet({ 
    ...
    try {
_responseData = deserialize<UserProfileDto, UserProfileDto>(_response.data!, 'UserProfileDto', growable: true);
...
_bodyData=jsonEncode(body);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> sendChangePasswordCode({ 
    SendChangePasswordCodeDto? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/app/account/send-change-password-code';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
...
_bodyData=jsonEncode(body);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> sendDeletionCode({ 
    SendDeletionCodeDto? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
