...
class UserStorageApi {
  ...
  Future<Response<UserStorageDto>> callGet({ 
    ...
    final _path = r'/api/app/user-storage';
    ...
    UserStorageDto _responseData;

    try {
_responseData = deserialize<UserStorageDto, UserStorageDto>(_response.data!, 'UserStorageDto', growable: true);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<List<UserStorageDto>>> getList({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
_responseData = deserialize<List<UserStorageDto>, UserStorageDto>(_response.data!, 'List<UserStorageDto>', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
