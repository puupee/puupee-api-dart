...
class FeaturesApi {
  ...
  Future<Response<GetFeatureListResultDto>> callGet({ 
    String? providerName,
    String? providerKey,
    ...
    try {
_responseData = deserialize<GetFeatureListResultDto, GetFeatureListResultDto>(_response.data!, 'GetFeatureListResultDto', growable: true);
