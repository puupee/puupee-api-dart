...
_responseData = deserialize<AppReleaseDtoPagedResultDto, AppReleaseDtoPagedResultDto>(_response.data!, 'AppReleaseDtoPagedResultDto', growable: true);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> apiAppAppReleaseIdDelete({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AppReleaseDto>> apiAppAppReleaseIdGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = deserialize<AppReleaseDto, AppReleaseDto>(_response.data!, 'AppReleaseDto', growable: true);
  ...
  Future<Response<AppReleaseDto>> apiAppAppReleaseLatestGet({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (name2 != null) r'Name': name2,
      if (value2 != null) r'Value': value2,
    };
