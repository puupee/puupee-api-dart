...
class SimpleDataApi {
  ...
  Future<Response<SimpleDataDtoPagedResultDto>> apiAppSimpleDataGet({ 
    String? collection,
    String? sorting,
    int? skipCount,
    int? maxResultCount,
    ...
    final _path = r'/api/app/simple-data';
...
_responseData = deserialize<SimpleDataDtoPagedResultDto, SimpleDataDtoPagedResultDto>(_response.data!, 'SimpleDataDtoPagedResultDto', growable: true);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> apiAppSimpleDataIdDelete({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SimpleDataDto>> apiAppSimpleDataIdGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = deserialize<SimpleDataDto, SimpleDataDto>(_response.data!, 'SimpleDataDto', growable: true);
  ...
  Future<Response<SimpleDataDto>> apiAppSimpleDataSavePost({ 
    ...
    final _path = r'/api/app/simple-data/save';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
