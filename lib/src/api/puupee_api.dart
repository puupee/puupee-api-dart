...
class PuupeeApi {
  ...
  Future<Response<PuupeeDto>> apiAppPuupeeByLinkedNamesGet({ 
    String? names,
    ...
    final _path = r'/api/app/puupee/by-linked-names';
...
_responseData = deserialize<PuupeeDto, PuupeeDto>(_response.data!, 'PuupeeDto', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<PuupeeDto>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<List<PuupeeDto>>> apiAppPuupeeDriversWithRootsGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/app/puupee/drivers-with-roots';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    List<PuupeeDto> _responseData;

    try {
_responseData = deserialize<List<PuupeeDto>, PuupeeDto>(_response.data!, 'List<PuupeeDto>', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<List<PuupeeDto>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<PuupeeDtoPagedResultDto>> apiAppPuupeePullGet({ 
    ...
    final _path = r'/api/app/puupee/pull';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = deserialize<PuupeeDtoPagedResultDto, PuupeeDtoPagedResultDto>(_response.data!, 'PuupeeDtoPagedResultDto', growable: true);
    ...
    return Response<PuupeeDtoPagedResultDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<PuupeeDto>> apiAppPuupeePushPost({ 
    ...
    final _path = r'/api/app/puupee/push';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
