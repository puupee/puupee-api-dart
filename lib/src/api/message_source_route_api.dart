...
class MessageSourceRouteApi {
  ...
  Future<Response<void>> apiAppMessageSourceRouteIdDelete({ 
    required String id,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<MessageSourceRouteDto>> apiAppMessageSourceRouteIdGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
_responseData = deserialize<MessageSourceRouteDto, MessageSourceRouteDto>(_response.data!, 'MessageSourceRouteDto', growable: true);
...
_bodyData=jsonEncode(body);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<List<MessageSourceRouteDto>>> apiAppMessageSourceRoutePublishedListSourceIdGet({ 
    ...
    final _path = r'/api/app/message-source-route/published-list/{sourceId}'.replaceAll('{' r'sourceId' '}', sourceId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
_responseData = deserialize<List<MessageSourceRouteDto>, MessageSourceRouteDto>(_response.data!, 'List<MessageSourceRouteDto>', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
