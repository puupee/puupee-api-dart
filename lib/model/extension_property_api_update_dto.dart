...
class ExtensionPropertyApiUpdateDto {
  ...
  static ExtensionPropertyApiUpdateDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ExtensionPropertyApiUpdateDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ExtensionPropertyApiUpdateDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ExtensionPropertyApiUpdateDto>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ExtensionPropertyApiUpdateDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ExtensionPropertyApiUpdateDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ExtensionPropertyApiUpdateDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = ExtensionPropertyApiUpdateDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<ExtensionPropertyApiUpdateDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ExtensionPropertyApiUpdateDto>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ExtensionPropertyApiUpdateDto.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
