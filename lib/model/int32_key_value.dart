...
class Int32KeyValue {
  ...
  static Int32KeyValue? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Int32KeyValue[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Int32KeyValue[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Int32KeyValue>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Int32KeyValue>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Int32KeyValue.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, Int32KeyValue> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = Int32KeyValue.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<Int32KeyValue>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Int32KeyValue>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Int32KeyValue.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
