...
class PuupeeDto {
  ...
  @override
  String toString() => 'PuupeeDto[id=$id, creationTime=$creationTime, creatorId=$creatorId, lastModificationTime=$lastModificationTime, lastModifierId=$lastModifierId, isDeleted=$isDeleted, deleterId=$deleterId, deletionTime=$deletionTime, name=$name, title=$title, description=$description, text=$text, format=$format, password=$password, parentId=$parentId, key=$key, url=$url, size=$size, md5=$md5, sliceMd5=$sliceMd5, rapidCode=$rapidCode, contentType=$contentType, type=$type, displayStyle=$displayStyle, extension_=$extension_, storageClass=$storageClass, storageObjectCreatedAt=$storageObjectCreatedAt, storageObjectUpdatedAt=$storageObjectUpdatedAt, storageObjectId=$storageObjectId, storageObject=$storageObject, thumb=$thumb, priority=$priority, doneAt=$doneAt, isDone=$isDone, startAt=$startAt, endAt=$endAt, notifyAt=$notifyAt, notifyTimingType=$notifyTimingType, notifyTimingUnit=$notifyTimingUnit, notifyTimingValue=$notifyTimingValue, repeat=$repeat, repeatOffAt=$repeatOffAt, repeatOffTimes=$repeatOffTimes, syncVersion=$syncVersion, isHidden=$isHidden, tagging=$tagging, lastModifierDeviceToken=$lastModifierDeviceToken, lastModifierDevice=$lastModifierDevice]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.storageObjectCreatedAt != null) {
      json[r'storageObjectCreatedAt'] = this.storageObjectCreatedAt!.toUtc().toIso8601String();
    } else {
      json[r'storageObjectCreatedAt'] = null;
    }
    if (this.storageObjectUpdatedAt != null) {
      json[r'storageObjectUpdatedAt'] = this.storageObjectUpdatedAt!.toUtc().toIso8601String();
    } else {
      json[r'storageObjectUpdatedAt'] = null;
    }
    if (this.storageObjectId != null) {
      json[r'storageObjectId'] = this.storageObjectId;
    } else {
      json[r'storageObjectId'] = null;
    }
    ...
    if (this.lastModifierDeviceToken != null) {
      json[r'lastModifierDeviceToken'] = this.lastModifierDeviceToken;
    } else {
  ...
  /// Returns a new [PuupeeDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PuupeeDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PuupeeDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PuupeeDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return PuupeeDto(
        ...
        storageObjectCreatedAt: mapDateTime(json, r'storageObjectCreatedAt', ''),
        storageObjectUpdatedAt: mapDateTime(json, r'storageObjectUpdatedAt', ''),
        storageObjectId: mapValueOfType<String>(json, r'storageObjectId'),
        storageObject: StorageObjectDto.fromJson(json[r'storageObject']),
        thumb: StorageObjectDto.fromJson(json[r'thumb']),
  ...
  static List<PuupeeDto>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PuupeeDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PuupeeDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PuupeeDto> mapFromJson(dynamic json) {
    final map = <String, PuupeeDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PuupeeDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PuupeeDto-objects as value to a dart map
  static Map<String, List<PuupeeDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PuupeeDto>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PuupeeDto.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
