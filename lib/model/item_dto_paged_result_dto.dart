...
class ItemDtoPagedResultDto {
  ...
  static ItemDtoPagedResultDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ItemDtoPagedResultDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ItemDtoPagedResultDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ItemDtoPagedResultDto>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ItemDtoPagedResultDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ItemDtoPagedResultDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ItemDtoPagedResultDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = ItemDtoPagedResultDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<ItemDtoPagedResultDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ItemDtoPagedResultDto>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ItemDtoPagedResultDto.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
