...
class NoteSpecDto {
  ...
  static NoteSpecDto fromJson(Map<String, dynamic> json) => NoteSpecDto(
  ...
  static List<NoteSpecDto> listFromJson(List json, {bool? growable,}) =>
    json.isNotEmpty
      ? json.map<NoteSpecDto>((i) => NoteSpecDto.fromJson(i as Map<String, dynamic>)).toList(growable: true == growable)
      : <NoteSpecDto>[];
  ...
  static Map<String, NoteSpecDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = NoteSpecDto.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of NoteSpecDto-objects as value to a dart map
  static Map<String, List<NoteSpecDto>> mapListFromJson(dynamic json, {bool? growable,}) {
    final map = <String, List<NoteSpecDto>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = NoteSpecDto.listFromJson(
            value,
            growable: growable,
          );
        });
