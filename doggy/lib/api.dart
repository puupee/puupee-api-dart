...
part 'model/create_thumb_dto.dart';
...
part 'model/identity_user_claim.dart';
...
part 'model/identity_user_login.dart';
part 'model/identity_user_organization_unit.dart';
part 'model/identity_user_role.dart';
part 'model/identity_user_token.dart';
...
part 'model/item_tag.dart';
part 'model/item_thumb.dart';
