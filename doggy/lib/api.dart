...
part 'model/create_push_notification_dto.dart';
part 'model/create_update_item_dto.dart';
part 'model/create_update_notification_dto.dart';
part 'model/create_update_tag_dto.dart';
part 'model/create_update_thumb_dto.dart';
...
part 'model/file_or_credentials_dto.dart';
...
part 'model/notification_dto_paged_result_dto.dart';
part 'model/notification_info_dto.dart';
part 'model/notification_info_dto_paged_result_dto.dart';
...
part 'model/thumb_dto.dart';
part 'model/thumb_dto_paged_result_dto.dart';
