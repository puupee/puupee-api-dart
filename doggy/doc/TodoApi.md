...
# **apiAppTodoSyncGet**
> TodoDtoPagedResultDto apiAppTodoSyncGet(afterVersion, skipCount, maxResultCount)
...
try {
    final result = api_instance.apiAppTodoSyncGet(afterVersion, skipCount, maxResultCount);
    print(result);
} catch (e) {
    print('Exception when calling TodoApi->apiAppTodoSyncGet: $e\n');
}
```
