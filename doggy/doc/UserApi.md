...
> Map<String, dynamic> apiIdentityUsersIdRolesPut(id, identityUserUpdateRolesDto)
...
try {
    final result = api_instance.apiIdentityUsersIdRolesPut(id, identityUserUpdateRolesDto);
    print(result);
} catch (e) {
