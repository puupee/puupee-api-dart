...
class FileApi {
  ...
  Future<DoggyFilesUploadCredentials?> apiAppFileUploadCredentialsGet() async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'DoggyFilesUploadCredentials',) as DoggyFilesUploadCredentials;
        }
  }
}
