...
class AbpApplicationConfigurationApi {
  ...
  Future<VoloAbpAspNetCoreMvcApplicationConfigurationsApplicationConfigurationDto?> apiAbpApplicationConfigurationGet() async {
    ...
    if (response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'VoloAbpAspNetCoreMvcApplicationConfigurationsApplicationConfigurationDto',) as VoloAbpAspNetCoreMvcApplicationConfigurationsApplicationConfigurationDto;
        }
  }
}
