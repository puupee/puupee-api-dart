...
class AbpTenantApi {
  ...
  ///
  /// * [String] id (required):
  Future<VoloAbpAspNetCoreMvcMultiTenancyFindTenantResultDto?> apiAbpMultiTenancyTenantsByIdIdGet(String id,) async {
    ...
    if (response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'VoloAbpAspNetCoreMvcMultiTenancyFindTenantResultDto',) as VoloAbpAspNetCoreMvcMultiTenancyFindTenantResultDto;
        }
  }
  ...
  ///
  /// * [String] name (required):
  Future<VoloAbpAspNetCoreMvcMultiTenancyFindTenantResultDto?> apiAbpMultiTenancyTenantsByNameNameGet(String name,) async {
