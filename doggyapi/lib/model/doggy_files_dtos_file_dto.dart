...
class DoggyFilesDtosFileDto {
  /// Returns a new [DoggyFilesDtosFileDto] instance.
  DoggyFilesDtosFileDto({
    this.id,
    this.creationTime,
    this.creatorId,
  ...
  List<DoggyItemsDtosItemDto>? folders;

  List<DoggyTagsDtosTagDto>? tags;

  @override
  bool operator ==(Object other) => identical(this, other) || other is DoggyFilesDtosFileDto &&
     other.id == id &&
  ...
  /// Returns a new [DoggyFilesDtosFileDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DoggyFilesDtosFileDto fromJson(Map<String, dynamic> json) => DoggyFilesDtosFileDto(
        ...
        folders: json[r'folders'] == null ? null : DoggyItemsDtosItemDto.listFromJson(json[r'folders']),
        tags: json[r'tags'] == null ? null : DoggyTagsDtosTagDto.listFromJson(json[r'tags']),
    );

  static List<DoggyFilesDtosFileDto> listFromJson(List json, {bool? growable,}) =>
    json.isNotEmpty
      ? json.map<DoggyFilesDtosFileDto>((i) => DoggyFilesDtosFileDto.fromJson(i as Map<String, dynamic>)).toList(growable: true == growable)
      : <DoggyFilesDtosFileDto>[];

  static Map<String, DoggyFilesDtosFileDto> mapFromJson(dynamic json) {
    final map = <String, DoggyFilesDtosFileDto>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = DoggyFilesDtosFileDto.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of DoggyFilesDtosFileDto-objects as value to a dart map
  static Map<String, List<DoggyFilesDtosFileDto>> mapListFromJson(dynamic json, {bool? growable,}) {
    final map = <String, List<DoggyFilesDtosFileDto>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = DoggyFilesDtosFileDto.listFromJson(
            value,
            growable: growable,
          );
        });
