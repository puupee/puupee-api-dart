...
class DoggyFilesUploadCredentials {
  /// Returns a new [DoggyFilesUploadCredentials] instance.
  DoggyFilesUploadCredentials({
    this.storageClass,
    this.endPoint,
    this.protocal,
    this.bucketName,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DoggyFilesUploadCredentials &&
  ...
  @override
  String toString() => 'DoggyFilesUploadCredentials[storageClass=$storageClass, endPoint=$endPoint, protocal=$protocal, bucketName=$bucketName, regionId=$regionId, prefix=$prefix, securityToken=$securityToken, accessKeyId=$accessKeyId, accessKeySecret=$accessKeySecret, expiration=$expiration, expiredTime=$expiredTime]';
  ...
  /// Returns a new [DoggyFilesUploadCredentials] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DoggyFilesUploadCredentials fromJson(Map<String, dynamic> json) => DoggyFilesUploadCredentials(
  ...
  static List<DoggyFilesUploadCredentials> listFromJson(List json, {bool? growable,}) =>
    json.isNotEmpty
      ? json.map<DoggyFilesUploadCredentials>((i) => DoggyFilesUploadCredentials.fromJson(i as Map<String, dynamic>)).toList(growable: true == growable)
      : <DoggyFilesUploadCredentials>[];

  static Map<String, DoggyFilesUploadCredentials> mapFromJson(dynamic json) {
    final map = <String, DoggyFilesUploadCredentials>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = DoggyFilesUploadCredentials.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of DoggyFilesUploadCredentials-objects as value to a dart map
  static Map<String, List<DoggyFilesUploadCredentials>> mapListFromJson(dynamic json, {bool? growable,}) {
    final map = <String, List<DoggyFilesUploadCredentials>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = DoggyFilesUploadCredentials.listFromJson(
            value,
            growable: growable,
          );
        });
