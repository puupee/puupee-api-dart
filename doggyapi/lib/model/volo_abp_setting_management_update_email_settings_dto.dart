...
class VoloAbpSettingManagementUpdateEmailSettingsDto {
  /// Returns a new [VoloAbpSettingManagementUpdateEmailSettingsDto] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is VoloAbpSettingManagementUpdateEmailSettingsDto &&
  ...
  /// Returns a new [VoloAbpSettingManagementUpdateEmailSettingsDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static VoloAbpSettingManagementUpdateEmailSettingsDto fromJson(Map<String, dynamic> json) => VoloAbpSettingManagementUpdateEmailSettingsDto(
  ...
  static List<VoloAbpSettingManagementUpdateEmailSettingsDto> listFromJson(List json, {bool? growable,}) =>
    json.isNotEmpty
      ? json.map<VoloAbpSettingManagementUpdateEmailSettingsDto>((i) => VoloAbpSettingManagementUpdateEmailSettingsDto.fromJson(i as Map<String, dynamic>)).toList(growable: true == growable)
      : <VoloAbpSettingManagementUpdateEmailSettingsDto>[];

  static Map<String, VoloAbpSettingManagementUpdateEmailSettingsDto> mapFromJson(dynamic json) {
    final map = <String, VoloAbpSettingManagementUpdateEmailSettingsDto>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = VoloAbpSettingManagementUpdateEmailSettingsDto.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of VoloAbpSettingManagementUpdateEmailSettingsDto-objects as value to a dart map
  static Map<String, List<VoloAbpSettingManagementUpdateEmailSettingsDto>> mapListFromJson(dynamic json, {bool? growable,}) {
    final map = <String, List<VoloAbpSettingManagementUpdateEmailSettingsDto>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = VoloAbpSettingManagementUpdateEmailSettingsDto.listFromJson(
            value,
            growable: growable,
          );
        });
