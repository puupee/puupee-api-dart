...
try {
    ...
    print('Exception when calling SimpleDataApi->delete: $e\n');
}
```
...
# **getList**
> SimpleDataDtoPagedResultDto getList(collection, sorting, skipCount, maxResultCount)
...
try {
    final response = api.getList(collection, sorting, skipCount, maxResultCount);
    print(response);
} catch on DioError (e) {
    print('Exception when calling SimpleDataApi->getList: $e\n');
}
```
...
try {
    final response = api.save(body);
    print(response);
} catch on DioError (e) {
    print('Exception when calling SimpleDataApi->save: $e\n');
}
```
