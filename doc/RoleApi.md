...
try {
    final result = api_instance.apiIdentityRolesIdPut(id, identityRoleUpdateDto);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.apiIdentityRolesPost(identityRoleCreateDto);
    print(result);
} catch (e) {
