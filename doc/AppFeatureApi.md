...
# **apiAppAppFeaturePut**
> AppFeatureDto apiAppAppFeaturePut(body)
...
try {
    final result = api_instance.apiAppAppFeaturePut(body);
    print(result);
} catch (e) {
    print('Exception when calling AppFeatureApi->apiAppAppFeaturePut: $e\n');
}
```
